        ...
        @if (Auth::user()->user_type == 1)
            ...
            <li class="nav-item menu-items">
                <a class="nav-link @if (Request::segment(2) == 'emergencies') active @endif"
                    href="{{ url('admin/emergencies/list') }}">
                    <span class="menu-icon">
                        <i class="mdi mdi-speedometer"></i>
                    </span>
                    <span class="menu-title">Unassigned Emergencies</span>
                </a>
            </li>
            <li class="nav-item menu-items">
                <a class="nav-link @if (Request::segment(2) == 'emergencies') active @endif"
                    href="{{ url('admin/emergencies/assignedlist') }}">
                    <span class="menu-icon">
                        <i class="mdi mdi-speedometer"></i>
                    </span>
                    <span class="menu-title">Assigned Emergencies</span>
                </a>
            </li>
            <!-- <li class="nav-item menu-items">
                <a class="nav-link @if (Request::segment(2) == 'emergencies') active @endif"
            ...
            <li class="nav-item menu-items">
                <a class="nav-link @if (Request::segment(3) == 'admin') active @endif"
                    href="{{ url('admin/medic/list') }}">
                    <span class="menu-icon">
                        <i class="mdi mdi-speedometer"></i>
                    </span>
                    <span class="menu-title">View medics</span>
                </a>
            </li>
            <li class="nav-item menu-items">
            ...
            <li class="nav-item menu-items">
                <a class="nav-link @if (Request::segment(3) == 'user') active @endif" href="{{url('admin/user/list')}}">
                    <span class="menu-icon">
                        <i class="mdi mdi-contacts"></i>
                    </span>
                    <span class="menu-title">Users {{Request::segment(3)}}</span>
                </a>
            </li>
            <li class="nav-item menu-items">
        ...
        @elseif(Auth::user()->user_type == 2)
            ...
            <li class="nav-item menu-items">
                <a class="nav-link" href="{{ url('admin/admin/list') }}">
                    ...
                    <span class="menu-title">Other Medics</span>
                </a>
            </li>
